...
@dataclass(frozen=True)
class DailyActivity:
    """A sample daily learning activity within a phase week."""

    day: str              # e.g. "Monday", "Tuesday", "Weekend"
    activity: str         # human-readable description with time estimate
    duration_minutes: int
    category: str = "technical"  # "technical" | "soft_skill" | "networking" | "reflection"
...
class Phase:
    ...
    # Enriched content — generated by LLM regardless of MCP/RAG data availability
    sample_weekly_schedule: list[DailyActivity] = field(default_factory=list)
    monthly_goals: list[str] = field(default_factory=list)
    book_recommendations: list[str] = field(default_factory=list)
